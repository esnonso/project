...
namespace fingerprint
{
    public partial class FingerEnroll : Form
    {
                ...
                try
                {
                    ...
                    if (count >= 4)
                    {
                        ...
                        if (resultEnrollment.ResultCode == Constants.ResultCode.DP_SUCCESS)
                        {
                            ...
                            MessageBox.Show(name + " Finger Print was successfully enrolled. Click Save to save");
                        }
        ...
        public SqlConnection conn = new SqlConnection("Data Source=DESKTOP-GIGBV97;Initial Catalog=DBAlJadeed;Integrated Security=True;MultipleActiveResultSets=True;");
        ...
        private void SaveUser()
        {
            if (resultEnrollment != null)
            {
                ...
                if (r > 0)
                {
                    MessageBox.Show("Data for " + name + " saved succesfully");
                    this.Close();
                }
                else
                {
